package org.iotashan.oauth
{
	...
	*/
	public class OAuthRequest
	{
		...
		*/
		public function buildRequest(signatureMethod:IOAuthSignatureMethod,resultType:String=RESULT_TYPE_URL_STRING,headerRealm:String="", timeOffset:Number=0):*
		{
			var local:Number = new Date().time;
			var timeChange:Number = local + timeOffset;
			var curDate:Date = new Date(timeChange);
			//var uuid:String = UIDUtil.getUID(curDate);
			var uuid:String = new Date().time.toString();
